...
<html lang="en" dir="ltr">
    <head>
        <meta charset="utf-8">
        <title>CMS Bernadete | Níveis</title>
        <link type="text/css" rel="stylesheet" href="CSS/style.css">
        <link type="text/css" rel="stylesheet" href="CSS/style_avaliacao.css">
        <script src="JavaScript/jquery-3.3.1.js"></script>
        <script src="JavaScript/ajax_avaliacao_crud.js"></script>
    </head>
    <body>
            ...
            <div id="main_content">
                ...
                <div id="content">
                    ...
                    <div id="register_content">
                        ...
                        <input type="text" name="txt_avaliacao" id="txt_avaliacao" placeholder="Digite a opção de resposta" class="input_text" style="width:350px;">
