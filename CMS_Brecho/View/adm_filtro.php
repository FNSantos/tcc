...
<html lang="en" dir="ltr">
    <head>
        <meta charset="utf-8">
        <title>CMS Bernadete | Categoria</title>
        <link type="text/css" rel="stylesheet" href="CSS/style.css">
        <link type="text/css" rel="stylesheet" href="CSS/style_filtro.css">
        <script src="JavaScript/jquery-3.3.1.js"></script>
        <script src="JavaScript/ajax_filtro_crud.js"></script>
    </head>
    <body>
            ...
            <div id="main_content">
                ...
                <div id="content">
                    ...
                    <div id="register_content">
                        ...
                        <input type="text" name="txt_nome" id="txt_nome" placeholder="Digite o nome da Categoria" class="input_text" style="width:350px;">
