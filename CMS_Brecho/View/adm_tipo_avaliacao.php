...
<html lang="en" dir="ltr">
    <head>
        ...
        <script src="JavaScript/ajax_tipo_avaliacao_crud.js"></script>
    </head>
    <body>
            ...
            <div id="main_content">
                ...
                <div id="content">
                    ...
                    <div id="register_content">
                        ...
                        <input type="text" name="txt_nome" id="txt_nome" placeholder="Digite a opção de resposta" class="input_text" style="width:350px;">
